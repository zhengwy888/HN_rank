  ...
  inpdir=../hn_1kb2 # <= change this to where rcv1 data is. 
  ...
  log_fn=log_output/hn_1kb2_seq2_${current_time}.log
  perf_fn=perf/hn_1kb2_seq2-perf_${current_time}.csv
  echo 
  ...
  # started with 1000
  # 500 seq2.param -> 0.3
  # 600 -> out of mem after 8 iter
  # 500 seq2-200i.param -> 0.32
  nodes=500 # number of neurons (weight vectors) in the convolution layers
